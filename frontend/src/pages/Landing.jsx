...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-linear-to-br from-emerald-50/80 via-white to-blue-50/50">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative py-16 lg:py-24">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="relative">
                <div className="bg-white rounded-2xl shadow-2xl shadow-emerald-200/30 border border-slate-200 overflow-hidden">
                  <div className="bg-slate-100 px-4 py-3 border-b border-slate-200 flex items-center gap-2">
                    ...
                    <span className="text-xs text-slate-500 ml-2">SoloHub Dashboard</span>
                  </div>
                  <div className="p-6">
                    <div className="grid grid-cols-2 gap-3 mb-4">
                      <div className="bg-emerald-50 p-3 rounded-lg border border-emerald-100">
                        <p className="text-xs text-slate-500">Revenue</p>
                        <p className="text-lg font-bold text-emerald-600">₦1.2M</p>
                      </div>
                      <div className="bg-amber-50 p-3 rounded-lg border border-amber-100">
                        <p className="text-xs text-slate-500">Pending</p>
                        <p className="text-lg font-bold text-amber-600">₦450K</p>
                      </div>
                    </div>
                    <div className="bg-slate-50 p-3 rounded-lg border border-slate-200 mb-3">
                      <div className="flex justify-between text-sm">
                        <span>Revenue Overview</span>
                        <span className="text-emerald-600 text-xs">↑ 18.2%</span>
                      </div>
                ...
                <div className="absolute -bottom-4 -left-4 w-20 h-20 bg-blue-200 rounded-full opacity-20 blur-2xl"></div>
              </div>
            </div>
          </div>
        </div>
